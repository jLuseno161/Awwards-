...
class ProfileTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.profile = Profile(id=4, profile_pic='profile.jpg', bio='this is a test profile',contact='0700000000',
                                    user=self.user)
...
class ProjectTestClass(TestCase):
    ...
    def setUp(self):
        ...
        self.new_profile = Profile(id=4, profile_pic='profile.jpg', bio='this is a test profile',contact='0700000000',
                                    user=self.user)
        self.new_profile.save()
        self.new_project = Project(image='profile.png',title="image",url='http', description='test profile description', date='20/04/2020',
...
class RatesTestCase(TestCase):
    def setUp(self):
        ...
        self.new_project = Project(image='profile.png',title="image",url='http', description='test profile description', date='20/04/2020',
        profile=self.new_profile)
        self.rate = Rates(design='asdfgh',usability='asdfg',content='dfghjk',project = self.new_project, date="23-01-2020")
